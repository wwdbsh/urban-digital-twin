...
import { SOUTHERN_REMAINDER_T1, exteriorT1InventoryNote } from "../src/release/exterior-t1-variants.ts";
 ...
 * between two copies.
 */
const SCRIPT_NAME = "scripts/southern-remainder-cli.mjs";
...
RELEASE_VARIANTS.t1 = {
  ...RELEASE_VARIANTS.p1,
  variantId: "t1",
  releaseId: SOUTHERN_REMAINDER_T1.releaseId,
  outputDirectory: SOUTHERN_REMAINDER_T1.outputDirectory,
  workRoot: "artifacts/southern-remainder-20260812-t1",
  recordRoot: "data/southern-remainder-20260812-t1",
  waveProfile: SOUTHERN_REMAINDER_T1.waveProfile,
  predecessorReleaseId: SOUTHERN_REMAINDER_T1.predecessorReleaseId,
  predecessorInventoryPath: join(repositoryRoot, "data/southern-remainder-20260812-p1", "payload-inventory.json"),
  predecessorOf: SOUTHERN_REMAINDER_T1.predecessorOf,
  releaseProfile: SOUTHERN_REMAINDER_T1.releaseProfile,
  stages: ["plans", "glbs", "gates", "graph"],
  inventoryNote: exteriorT1InventoryNote(SOUTHERN_REMAINDER_T1, SCRIPT_NAME),
};
