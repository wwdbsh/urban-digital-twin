...
describe("Block 835 reference build CLI target guard", () => {
  ...
  it("explains how to proceed when a scratch target exists but is not this package", async () => {
    ...
    expect(result.stderr).toMatch(/manhattan-esb-block-reference-20260810 or manhattan-esb-block-reference-20260811 or manhattan-esb-block-reference-20260811-v3 or manhattan-esb-block-reference-20260811-v3t or manhattan-esb-block-reference-20260811-v3e manifest/u);
