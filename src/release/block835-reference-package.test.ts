...
import { multiLodAssemblyFingerprint, replayMultiLodAssembly } from "./multi-lod-assembly";

const release = releaseJson as unknown;
const RELEASE_CHECKSUM = sha256HexBytes(new TextEncoder().encode(stableSerialize(release)));
