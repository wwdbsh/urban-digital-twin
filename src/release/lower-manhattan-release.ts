 ...
 * - display is LOCAL, inside the conveyance envelope the base geometry already
 *   has. This instrument broadens nothing about the NYC OTI source data.
 *
